      ...
      <div className="mx-auto max-w-5xl px-5 py-20">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 md:items-stretch">
          ...
          <div className="relative flex flex-col rounded-xl2 border-2 border-ink bg-paper p-8 shadow-card">
            ...
            <a
              href="https://whop.com/checkout/plan_1JZiNyP1WDTH1"
    ...
    <section className="dotgrid">
      <div className="mx-auto max-w-3xl px-5 py-24 text-center">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <a href="https://whop.com/checkout/plan_1JZiNyP1WDTH1" className="rounded-lg border border-line bg-card px-6 py-3 text-base font-semibold text-ink transition-colors hover:bg-paper">
            Get 1 year for $249
          </a>
        </div>
